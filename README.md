...
2). ทดลองเรื่องจำนวนของอาร์กิวเมนต์ในคำสั่ง Console.WriteLine()
 ...
 2.1). แก้โปรแกรมตามรูปด้านล่างนี้
  ...
  จากการทดลอง โดยการพิมพ์โค้ดตามข้างต้นแล้วทำการรัน จะพบว่ามีหน้าต่างพื้นีดำขึ้นมา แสดงคำว่า This is text 1. เว้นบรรทัด This is text 2. เว้นบรรทัด This is text 3. เว้นบรรทัด Preess any key continue . . . แสดงดังภาพ
!()[]
